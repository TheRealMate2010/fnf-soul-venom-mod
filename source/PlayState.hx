...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		switch (songLowercase)
		{
			...
			case 'sighofdespair':
				dialogue = CoolUtil.coolTextFile(Paths.txt('sighofdespair/sighofdespairDialogue'));
			case 'getout':
				dialogue = CoolUtil.coolTextFile(Paths.txt('getout/getoutDialogue'));
			case 'soulvenom':
				dialogue = CoolUtil.coolTextFile(Paths.txt('soulvenom/soulvenomDialogue'));
		}
